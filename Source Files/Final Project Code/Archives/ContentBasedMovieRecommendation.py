...
credits = pd.read_csv(os.path.join(currentDirPath, 'Database', 'credits.csv'))
keywords = pd.read_csv(os.path.join(currentDirPath, 'Database', 'keywords.csv'))
movies = pd.read_csv(os.path.join(currentDirPath, 'Database', 'movies_metadata.csv')).\
...
ratings_df = pd.read_csv(os.path.join(currentDirPath, 'Database', 'ratings_small.csv'))
